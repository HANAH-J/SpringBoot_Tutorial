...
import site.myduck.springbootdeveloper.config.oauth.OAuth2SuccessHandler;
import site.myduck.springbootdeveloper.config.oauth.OAuth2UserCustomService;
...
public class WebOAuthSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // 토큰 재발급 URL은 인증 없이 접근 가능하도록 설정하며 나머지 API URL은 인증 필요
